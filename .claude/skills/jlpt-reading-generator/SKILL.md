...
async def capture_screenshot(html_path, img_path):
    ...
    async with async_playwright() as p:
        ...
        """)
        # Đo content height thực (KHÔNG dùng bounding_box vì container stretch theo body)
...
| TC5 | Furigana | Sót furigana context words, thừa furigana key terms, ruby count vượt ngưỡng, format sai |
