...
```bash
python3 .claude/skills/jlpt-reading-generator-post-qc/scripts/post_qc.py \
...
```bash
python3 .claude/skills/jlpt-reading-generator/scripts/check_furigana.py --html-dir assets/html/tim_thong_tin --level-from-filename --csv rules/kanji_jlpt_sensei.csv
python3 .claude/skills/jlpt-reading-generator/scripts/check_spacing.py --html-dir assets/html/tim_thong_tin --level-from-filename
python3 .claude/skills/jlpt-reading-generator/scripts/check_csv_fields.py --csv sheets/samples_v1.csv --kind info
python3 .claude/skills/jlpt-reading-generator/scripts/check_answer_punctuation.py --csv sheets/samples_v1.csv
```
...
4. **Chạy lại QC**: Chạy lại post_qc.py trên toàn bộ CSV:
   ```bash
   python3 .claude/skills/jlpt-reading-generator-post-qc/scripts/post_qc.py --csv sheets/samples_v1.csv --verbose
   ```
...
- **Đọc lại rules**: Trước khi sửa, đọc lại rule liên quan trong `rules/` và `.claude/skills/jlpt-reading-generator/SKILL.md`.
