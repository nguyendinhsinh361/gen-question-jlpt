...
2. Chụp screenshot (Playwright, viewport 700×1200, crop container bằng `container.screenshot()`, 1500ms chờ font) → `assets/img/tim_thong_tin/{LEVEL}_{uuid}.png`
...
- Kiểm tra chars trong khoảng 700-770
