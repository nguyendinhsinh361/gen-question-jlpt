...
6. Điền câu hỏi, đáp án, explanation vào CSV bằng **fill_qa.py**:
   ...
   ```bash
   python3 .gemini/skills/jlpt-reading-generator/scripts/fill_qa.py \
...
| 37 | **Chữ rõ ràng, không bị che** | Nhìn ảnh | Chữ không mờ, không bị che, không tràn |
